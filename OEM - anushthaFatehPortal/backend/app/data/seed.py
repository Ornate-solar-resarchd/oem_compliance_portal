...
# ─── PROJECT PIPELINE (Full Deal Lifecycle) ───
# Stages: enquiry → rfq → meeting → request → proposal → final
...
PIPELINE = [
    {
        "id": "deal-001",
        "title": "NTPC REL Bikaner 1000 MWh BESS",
        "customer": "NTPC Renewable Energy Ltd",
        "contact_person": "Om Prakash (AGM)",
        "contact_email": "omprakash08@ntpc.co.in",
        "contact_phone": "+91-9650994070",
        "stage": "proposal",
        "capacity": "250 MW / 1000 MWh",
        "location": "Bikaner, Rajasthan",
        "project_type": "utility",
        "estimated_value": "INR 1530 Cr",
        "rfq_id": None,
        "priority": "high",
        "created_at": "2026-02-06T10:00:00Z",
        "updated_at": "2026-03-15T14:00:00Z",
        "notes": "IFB No: NREL-CS-5800-004(BESS1)-9. Bid security INR 20 Cr. Reverse auction after techno-commercial evaluation.",
        "activities": [
            {"date": "2026-02-06", "type": "enquiry", "note": "IFB published on ETS portal"},
            {"date": "2026-02-12", "type": "rfq", "note": "Bidding documents downloaded, NDA submitted"},
            {"date": "2026-02-25", "type": "meeting", "note": "Pre-bid conference attended, queries submitted"},
            {"date": "2026-03-01", "type": "request", "note": "Technical bid preparation started, OEM shortlisting in progress"},
            {"date": "2026-03-10", "type": "proposal", "note": "Techno-commercial bid submitted via ETS portal"},
        ],
    },
    {
        "id": "deal-002",
        "title": "Evolve Energy 15MW/45MWh Solar+BESS",
        "customer": "Evolve Energy Group",
        "contact_person": "Mr. Tennison",
        "contact_email": "tennison@evolveindia.in",
        "contact_phone": "+91-73059 83253",
        "stage": "meeting",
        "capacity": "15 MW / 45 MWh",
        "location": "Tamil Nadu",
        "project_type": "hybrid",
        "estimated_value": "INR 85 Cr",
        "rfq_id": "rfq-003",
        "priority": "high",
        "created_at": "2026-01-20T10:00:00Z",
        "updated_at": "2026-03-10T11:00:00Z",
        "notes": "RFQ Ref: EEG/BESS-EMS/RFQ/2025-01. Solar+BESS+EMS turnkey. Mandatory Make in India EMS.",
        "activities": [
            {"date": "2026-01-20", "type": "enquiry", "note": "Initial inquiry via email from Evolve Energy"},
            {"date": "2026-02-01", "type": "rfq", "note": "Formal RFQ received — 15MW/45MWh with EMS/SCADA"},
            {"date": "2026-03-10", "type": "meeting", "note": "Technical discussion scheduled for OEM selection and EMS compliance"},
        ],
    },
    {
        "id": "deal-003",
        "title": "BSPGCL Bihar Grid Storage 500 MWh",
        "customer": "BSPGCL",
        "contact_person": "Chief Engineer (RE)",
        "contact_email": "ce-re@bspgcl.gov.in",
        "contact_phone": "",
        "stage": "rfq",
        "capacity": "125 MW / 500 MWh",
        "location": "Patna, Bihar",
        "project_type": "utility",
        "estimated_value": "INR 750 Cr",
        "rfq_id": "rfq-002",
        "priority": "medium",
        "created_at": "2026-03-01T09:00:00Z",
        "updated_at": "2026-03-05T10:00:00Z",
        "notes": "State utility project. BIS certification mandatory. RTE ≥96% required.",
        "activities": [
            {"date": "2026-03-01", "type": "enquiry", "note": "Tender notice published in newspaper"},
            {"date": "2026-03-05", "type": "rfq", "note": "RFQ document received and technical requirements extracted"},
        ],
    },
    {
        "id": "deal-004",
        "title": "Eagle Infra TNGECL C&I BESS",
        "customer": "Eagle Infra / TNGECL",
        "contact_person": "Project Manager",
        "contact_email": "pm@eagleinfra.in",
        "contact_phone": "+91-44-28901234",
        "stage": "request",
        "capacity": "5 MW / 25 MWh",
        "location": "Chennai, Tamil Nadu",
        "project_type": "ci",
        "estimated_value": "INR 35 Cr",
        "rfq_id": None,
        "priority": "medium",
        "created_at": "2026-01-15T10:00:00Z",
        "updated_at": "2026-03-12T16:00:00Z",
        "notes": "C&I project for industrial park. Client wants cost-optimized solution.",
        "activities": [
            {"date": "2026-01-15", "type": "enquiry", "note": "Cold call lead — interested in C&I BESS"},
            {"date": "2026-02-01", "type": "rfq", "note": "Informal requirements shared via email"},
            {"date": "2026-02-15", "type": "meeting", "note": "Site visit and technical discussion completed"},
            {"date": "2026-03-12", "type": "request", "note": "Formal bid request received, preparing technical proposal"},
        ],
    },
    {
        "id": "deal-005",
        "title": "SunSure Energy BTM BESS Gurugram",
        "customer": "SunSure Energy Pvt. Ltd.",
        "contact_person": "VP Business Development",
        "contact_email": "bd@sunsure.in",
        "contact_phone": "+91-124-4567890",
        "stage": "enquiry",
        "capacity": "250 kW / 522 kWh",
        "location": "Gurugram, Haryana",
        "project_type": "btm",
        "estimated_value": "INR 4.5 Cr",
        "rfq_id": None,
        "priority": "low",
        "created_at": "2026-03-18T10:00:00Z",
        "updated_at": "2026-03-18T10:00:00Z",
        "notes": "Small BTM project for commercial building. Initial inquiry stage.",
        "activities": [
            {"date": "2026-03-18", "type": "enquiry", "note": "Inquiry received via website contact form"},
        ],
    },
    {
        "id": "deal-006",
        "title": "Amrita Hospital Kochi BTM BESS",
        "customer": "Amrita Hospitals",
        "contact_person": "Head of Engineering",
        "contact_email": "engineering@amritahospital.org",
        "contact_phone": "+91-484-2801234",
        "stage": "final",
        "capacity": "11 MW / 20 MWh",
        "location": "Kochi, Kerala",
        "project_type": "btm",
        "estimated_value": "INR 28 Cr",
        "rfq_id": None,
        "priority": "high",
        "created_at": "2025-10-01T10:00:00Z",
        "updated_at": "2026-03-18T15:00:00Z",
        "notes": "Hospital BTM project — critical power backup + peak shaving. Won the bid.",
        "outcome": "won",
        "activities": [
            {"date": "2025-10-01", "type": "enquiry", "note": "Hospital management approached for BESS consultation"},
            {"date": "2025-10-15", "type": "rfq", "note": "Technical requirements finalized with hospital engineering team"},
            {"date": "2025-11-10", "type": "meeting", "note": "Site survey and load analysis completed"},
            {"date": "2025-12-05", "type": "request", "note": "Formal tender issued by hospital procurement"},
            {"date": "2026-01-20", "type": "proposal", "note": "Technical + commercial proposal submitted (BYD Blade cells)"},
            {"date": "2026-03-18", "type": "final", "note": "Bid won! LOI received. Project kickoff in April."},
        ],
    },
]
